...
public class EducationTaskHelper extends SQLiteOpenHelper {


    public EducationTaskHelper(Context context){
        super(context,"dbEducationTasks", null, 1);
    }

    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String sql1 = "CREATE TABLE tasks (_id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, deadline DATE, completedDate DATE, complete BOOLEAN)";
